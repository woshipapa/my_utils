...
class RollAdapter(FrameworkAdapter):
    ...
    def detect(self, context: Mapping[str, Any]) -> bool:
        ...
        return (
            "/roll/" in command
            or "alibaba.github.io/roll" in command
            or "run_agentic_pipeline_" in command
            or "examples/agentic_demo" in command
        )
    ...
    def build_runtime_tags(self, context: Mapping[str, Any]) -> Dict[str, str]:
        return {"framework": self.name, "adapter": "RollAdapter"}
