...
def test_rank_skew_detection() -> None:
    ts = time.time()
    events = [
        MetricEvent(ts, "latency.stage", 10.0, "ms", provider_id="ut", tags={"step": "0", "rank": "0", "stage": "fwd"}),
        MetricEvent(ts, "latency.stage", 20.0, "ms", provider_id="ut", tags={"step": "0", "rank": "1", "stage": "fwd"}),
        MetricEvent(ts, "latency.stage", 9.0, "ms", provider_id="ut", tags={"step": "1", "rank": "0", "stage": "fwd"}),
        MetricEvent(ts, "latency.stage", 22.0, "ms", provider_id="ut", tags={"step": "1", "rank": "1", "stage": "fwd"}),
    ]
